...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/readit)](https://CRAN.R-project.org/package=readit)
...
You can install the development released version of readit from Github with:
